...
//    public static void deplaceRobot(Robot robot, Case end, long tpsDebut) {
//        Carte map = robot.getCarte();
//        Simulateur simu = robot.getSimu();
//        Case start = robot.getPosition();
//        int nbL = map.getNbLignes();
//        int nbC = map.getNbColonnes();
//        int posL = start.getLigne();
...
//        while (posLcour != posL && posCcour != posC) {
